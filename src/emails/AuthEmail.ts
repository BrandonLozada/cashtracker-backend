...
export class AuthEmail {
    ...
    static sendResetTokenEmail = async (user: EmailType) => {
        const email = await transport.sendMail({
            from: 'Cashtracker <admin@cashtracker.com>',
            to: user.email,
            ...
            <head>
                <meta charset="UTF-8" />
                <meta name="viewport" content="width=device-width, initial-scale=1.0" />
                <title>Restablece tu contraseña - Cashtracker</title>
                <style>
                    body {
                        margin: 0;
                        padding: 0;
            ...
            <body>
                <main class="container">
                    <section class="card">
                        <h1>Hola, ${user.name} 👋</h1>
                        <p>Has solicitado restablecer tu <strong>contraseña</strong>.</p>
                        <p>Para hacer el cambio, por favor haz clic en el siguiente botón:</p>
                        <a href="#" class="btn">Restablecer contraseña</a>
                        <p>Ingresando el siguiente código de confirmación:</p>
                        <div class="code-box">${user.token}</div>
                        <p>Si no has solicitado restablecer la contraseña, puedes ignorar este correo.</p>
                        <p>¡Gracias por confiar en nosotros!<br/>— El equipo de Cashtracker</p>
                    </section>
                </main>
            </body>
